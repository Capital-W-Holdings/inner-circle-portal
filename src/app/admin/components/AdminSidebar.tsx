...
export function AdminSidebar(): React.ReactElement {
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed inset-0 z-40 bg-gray-900/80 hidden" id="sidebar-backdrop" />
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-gray-900 overflow-y-auto">
          ...
          <div className="flex-shrink-0 px-4 py-4 border-t border-gray-800">
            ...
            >
              <svg className="w-5 h-5 mr-3 text-gray-400 group-hover:text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
